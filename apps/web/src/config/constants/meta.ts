...
export const DEFAULT_META: PageMeta = {
  title: 'TigerSwap',
  description:
    'The most popular AMM on BSC by user count! Earn Tiger through yield farming or win it in the Lottery, then stake it in Pools to earn more tokens! Initial Farm Offerings (new token launch model pioneered by TigerSwap), NFTs, and more, on a platform you can trust.',
  image: 'https://app.tigerswap.global/images/hero.png',
}
...
const getPathList = (t: ContextApi['t']): PathList => {
  return {
    paths: {
      ...
      '/info': { title: t('Overview'), description: 'View statistics for exchanges.' },
      '/info/pools': { title: t('Pairs'), description: 'View statistics for  exchanges.' },
      '/info/tokens': { title: t('Tokens'), description: 'View statistics for  exchanges.' },
    ...
    defaultTitleSuffix: t('PTigerSwap'),
  }
}
